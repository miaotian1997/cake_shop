...
(function(){
  $.ajax({
  url:"http://127.0.0.1:3000/user/cake_list",
  type:"get",
  //data:"",
  ...
  for(var i=0;i<4;i++){
    ...
    html+=` 
    <li>
      <a href="http://127.0.0.1:3000/products_details.html" >
        <img src="${p.img_url}" alt="">
      </a>
      <h5><a href="http://127.0.0.1:3000/products_details.html">${p.title}</a></h5>
      <p class="intro">
        <span>${p.details}</span>
      </p>
      <p class="circle">
